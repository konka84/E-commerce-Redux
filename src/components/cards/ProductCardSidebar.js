...
import { remove } from "../../Redux/cart/cartAction";
import { decrease, increase } from "../../Redux/cart/cartAction";
        ...
        <div className="bg-purple-200 hover:bg-purple-200 transform transition hover:scale-102 mx-2 my-3 px-3 py-1 flex flex-wrap flex-row rounded-md">
            ...
            <div className="flex w-full py-1">
                ...
                <div className="flex space-x-3 justify-around flex-grow px-8 space-x-4">
                    ...
                    <button onClick={() =>  dispatch(decrease(id))} className="bg-purple-400 transition transform hover:scale-110 px-2 py-0 rounded-full" ><i className="fa fa-minus font-bold text-xl"></i></button>
                    <button onClick={() =>dispatch(increase(id)) } className="bg-purple-400 transition transform hover:scale-110 px-2 py-0 rounded-full" ><i className="fa fa-plus font-bold text-xl"></i></button>
